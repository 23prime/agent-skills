...
description: Use when the user wants to add a new instruction to CLAUDE.md, AGENTS.md, or .claude/rules/, or when CLAUDE.md has grown large and needs to be reorganized into topic-scoped rules.
---
