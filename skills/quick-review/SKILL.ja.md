---
name: quick-review
description: コミット前の未コミット変更（ステージ済み・未ステージ）をバグやロジックミスに焦点を当てて素早くレビューするスキル。コミット前にワーキングツリーの変更を手軽にコードレビューしたい場合に使用する。
...
ワーキングツリーのすべての未コミット変更に対して、バグ、ロジックミス、明らかな問題に焦点を当てた簡易レビューを行う。
